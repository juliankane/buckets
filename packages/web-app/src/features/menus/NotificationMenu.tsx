    ...
    return (
        <div className="relative inline-block">
            ...
            {open && (
                <div
                  ref={menuRef}
                  className="absolute bg-background right-0 mt-6 w-64 rounded-lg shadow-black/20 z-10
                            shadow-[10px_0px_30px_rgba(0,0,0,0.5)]"
                >
                  <div className="flex justify-between space-x-2 p-3 max-size-[10px] border-b border-border">
                  ...
                  <ul className="space-y-2 p-3">
                    {[
                      ...
                      <div className={`block w-full text-left px-4 py-2 hover:bg-background-secondary
                        ${idx !== arr.length - 1 ? "border-b border-bordere" : ""}`}
                        key={notification}
                      >
                        {notification}
                      </div>
